...
def home():
    if request.method =="POST":
        ...
        # 
        if prediction==0:
            prediction = "Congrats, You don't have Stroke." 
        else:
            prediction = "Go check with doctor, Stroke prediction is yes" 

        return render_template("index.html", prediction_result="Chance of Stroke Prediction is --> {}".format(prediction))   
